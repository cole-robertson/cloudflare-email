...
| Prior compatibility CI | **12/12 jobs passed on 9d1cd58** | Eleven Ruby/Rails combinations plus Worker unit/build/audit; follow-up CI adds local workerd and packaged checks |
